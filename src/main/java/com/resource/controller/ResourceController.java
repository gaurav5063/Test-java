...
public class ResourceController {
	...
	@PostMapping("/restn")
	public ConstantKeys registrationEmployee(@Valid @RequestBody Resources resources) throws RegistrationException {
	...
	public List<Resources> filterByStatus(@PathVariable String status,@PathVariable String type,@PathVariable String officeCity) throws FilterException{
