...
public class ResourceService {
	...
	public Optional<Resources> login(Resources resources) {
		Optional<Resources> dbDetails=resourceRepo.findById(resources.getEmployeeId());
	...
	public ConstantKeys register(Resources resources) {
		...
		return ConstantKeys.REGISTRATION_SUCESSSFULLY;
	}


	public ConstantKeys forgetpass(String empid, String email, String password) {

		Optional<Resources> dbDetails=resourceRepo.findById(empid);
